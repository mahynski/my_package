...
4. When finished go to [Zenodo](https://zenodo.org/) and enable preservation of this repo; then create a release on GitHub.  Update the badge in this `README.md` file and in the `docs/index.rst` file with the new one generated by Zenodo.
